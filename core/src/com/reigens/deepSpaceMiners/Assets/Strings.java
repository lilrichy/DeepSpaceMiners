...
public class Strings {
    ...
    public static String level1 = "Welcome to the Deep Space Miners, we sure are glad to have you. \n\n" +
            ...
            " That's your mission, head out to the meteor belt at the edge of the galaxy and start gathering the smaller meteors that are on the outside. \n\n" +

            "We have assigned you a small ship that has a worm hole teleportation device that will send the meteors back to our processing facility. \n\n" +
