...
public class GameScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        batch.draw(Assets.sprite_background, 0, 0, camera.viewportWidth, camera.viewportHeight);
        ...
        batch.draw(Assets.sprite_scorePanelLeft, -50, 1080 -200, 650, 300);
        batch.draw(Assets.sprite_scorePanelRight,1320, 1080 -200, 650, 300);
    ...
    public void generalUpdate(Vector3 touch, OrthographicCamera camera) {
        ...
        if (TimeUtils.nanoTime() - lastDropTime > 500000000) RegularMeteor.spawnMeteor();
        if (TimeUtils.nanoTime() - lastDropTime > 1000000) fallSpeed += 60 * Gdx.graphics.getDeltaTime();
